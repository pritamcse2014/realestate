                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center">
                            <a class="btn btn-primary" href="{{ url('admin/state/add') }}">Add State</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="table-info text-dark">
                                    ...
                                    <td>
                                        <a class="dropdown-item" href="{{ url('admin/state/edit/' .$value->id) }}">
                                            <svg
                                        ...
                                        <a class="dropdown-item" href="{{ url('admin/state/delete/' .$value->id) }}" onclick="return confirm('Are you sure you want to delete?')">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
