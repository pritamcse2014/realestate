                ...
                <div class="card-body">
                    ...
                    <form method="GET" action="">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="mb-3">
                                    <label class="form-label">Enter Your Week Time</label>
                                    <input class="form-control" type="time" name="name" id="name" value="{{ Request()->name }}" placeholder="Enter Your Week Time" />
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="mb-3">
                        ...
                        <a class="btn btn-danger ms-1" href="{{ url('admin/time') }}">Reset</a>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center">
                            <a class="btn btn-primary" href="{{ url('admin/time/add') }}">Add Week Time</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr class="table-info text-dark">
                                    ...
                                    <td>
                                        <a class="dropdown-item" href="{{ url('admin/time/edit/' .$value->id) }}">
                                            <svg
                                        ...
                                        <a class="dropdown-item" href="{{ url('admin/time/delete/' .$value->id) }}" onclick="return confirm('Are you sure you want to delete?')">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
