            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="GET" action="">
                        ...
                        <a class="btn btn-danger ms-1" href="{{ url('admin/city') }}">Reset</a>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center">
                            <a class="btn btn-primary" href="{{ url('admin/city/add') }}">Add City</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="dropdown-item" href="{{ url('admin/city/edit/' .$value->id) }}">
                                            <svg
                                        ...
                                        <a class="dropdown-item" href="{{ url('admin/city/delete/' .$value->id) }}" onclick="return confirm('Are you sure you want to delete?')">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
