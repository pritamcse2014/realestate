            ...
            <div class="card">
                ...
                <div class="col-lg-9">
                    ...
                    <div>
                        ...
                        <a href="{{ url('admin/email/read/delete/'.$getRecord->id) }}"><i data-feather="trash" class="text-muted icon-lg"></i></a>
                    </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="actions dropdown">
                            ...
                            <a class="dropdown-item text-danger" href="{{ url('admin/email/read/delete/'.$getRecord->id) }}">Delete</a>
                            </div>
                        </div>
                        </div>
                    </div>
